...
Page({
  ...
  tohuxing:function(){
    ...
    wx.navigateTo({
      url: '../changehuxing/changehuxing',
    })
  },
  tomianji: function () {

    wx.navigateTo({
      url: '../changemianji/changemianji',
    })
  },
  toyusuan: function () {

    wx.navigateTo({
      url: '../changeyusuan/changeyusuan',
    })
  },
  fabu:function(){
    var that= this;
  ...
  guanbi:function(){
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: getApp().globalData.host + 'publish/diary/add_riji',
            header: {
              'content-type': 'application/json'
            },
            data: {
  ...
  savecaogao:function(){
    var that = this;
    wx.request({
      url: getApp().globalData.host + 'publish/diary/caogao',
      header: {
        'content-type': 'application/json'
      },
      data: {
  ...
  onLoad: function (options) {
    ...
    app.globalData.huxing = options.huxing;
    app.globalData.huxing = options.huxing;
    app.globalData.huxing = options.huxing;
    app.globalData.huxing = options.huxing;
  },
